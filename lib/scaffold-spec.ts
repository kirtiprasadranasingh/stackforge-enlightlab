...
export const PATH_ALIASES: Record<string, string[]> = {
  ...
  'app/index.js': ['index.js', 'src/index.js', 'app/server.js', 'server.js', 'app/main.py', 'main.py', 'app/main.go', 'main.go', 'app/Program.cs', 'Program.cs', 'app/src/main/java/com/example/health/Application.java'],
  'app/server.js': ['app/index.js', 'index.js', 'server.js', 'src/index.js', 'app/main.py', 'main.py', 'app/main.go', 'main.go', 'app/Program.cs', 'Program.cs', 'app/src/main/java/com/example/health/Application.java'],
  'app/package.json': ['package.json', 'app/requirements.txt', 'requirements.txt', 'app/go.mod', 'go.mod', 'app/app.csproj', 'app.csproj', 'app/pom.xml', 'pom.xml'],
  'app/package-lock.json': ['package-lock.json', 'app/requirements.txt', 'requirements.txt', 'app/go.sum', 'go.sum', 'app/app.csproj', 'app.csproj', 'app/pom.xml', 'pom.xml'],
