...
- Applied from interview: region=us-east-1; envs=development, staging, production; access=public_https; database=postgres; scale=medium; runtime=node; ci=github-actions.
